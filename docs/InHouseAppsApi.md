...
```bash
kandji_sdk inhouseAppsCreateInhouseApp Content-Type:value
```
...
```bash
kandji_sdk inhouseAppsDeleteInhouseApp library_item_id=value
```
...
```bash
kandji_sdk inhouseAppsGetInhouseApp library_item_id=value
```
...
```bash
kandji_sdk inhouseAppsListInhouseApps  page=value
```
...
```bash
kandji_sdk inhouseAppsUpdateInhouseApp library_item_id=value Content-Type:value
```
...
```bash
kandji_sdk inhouseAppsUploadInhouseApp Content-Type:value
```
...
```bash
kandji_sdk inhouseAppsUploadInhouseAppStatus pending_upload_id=value
```
