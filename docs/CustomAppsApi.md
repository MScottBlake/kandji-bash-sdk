...
```bash
kandji deleteCustomApp library_item_id=value
```
...
```bash
kandji getCustomApp library_item_id=value
```
...
```bash
kandji listCustomApps  page=value
```
...
```bash
kandji updateCustomApp library_item_id=value
```
