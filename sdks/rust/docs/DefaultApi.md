...
> serde_json::Value api_v1_blueprints_blueprint_id_assign_library_item_post(blueprint_id)
Assign Library Item
...
> serde_json::Value api_v1_blueprints_blueprint_id_delete(blueprint_id)
Delete Blueprint
...
> serde_json::Value api_v1_blueprints_blueprint_id_list_library_items_get(blueprint_id)
List Library Items
...
> serde_json::Value api_v1_blueprints_blueprint_id_ota_enrollment_profile_get(blueprint_id)
...
> serde_json::Value api_v1_blueprints_blueprint_id_remove_library_item_post(blueprint_id)
Remove Library Item
...
> serde_json::Value api_v1_blueprints_get()
List Blueprints
...
> serde_json::Value api_v1_blueprints_templates_get()
...
> serde_json::Value api_v1_devices_device_id_notes_note_id_get(device_id, note_id)
...
> serde_json::Value api_v1_devices_device_id_patch(device_id)
Update Device
...
> serde_json::Value api_v1_deviceslimit300_get()
List Devices
...
> serde_json::Value api_v1_integrations_apple_ade_ade_token_id_renew_post(ade_token_id)
...
> serde_json::Value api_v1_library_custom_profiles_library_item_id_patch(library_item_id)
...
> serde_json::Value api_v1_library_library_items_library_item_id_activity_get(library_item_id)
...
> serde_json::Value api_v1_library_library_items_library_item_id_status_get(library_item_id)
...
> serde_json::Value api_v1_prism_activation_lock_get()
Activation lock
...
> serde_json::Value api_v1_prism_application_firewall_get()
...
> serde_json::Value api_v1_prism_apps_get()
Applications
...
> serde_json::Value api_v1_prism_certificates_get()
Certificates
...
> serde_json::Value api_v1_prism_countcategoryapps_get()
Count
...
> serde_json::Value api_v1_prism_desktop_and_screensaver_get()
...
> serde_json::Value api_v1_prism_device_information_get()
Device information
...
> serde_json::Value api_v1_prism_export_export_id_get(export_id)
Get category export
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**export_id** | **String** | Path parameter 'export_id' | [required] |
...
> serde_json::Value api_v1_prism_export_post()
...
> serde_json::Value api_v1_prism_filevault_get()
FileVault
...
> serde_json::Value api_v1_prism_gatekeeper_and_xprotect_get()
...
> serde_json::Value api_v1_prism_installed_profiles_get()
Installed profiles
...
> serde_json::Value api_v1_prism_kernel_extensions_get()
Kernel Extensions
...
> serde_json::Value api_v1_prism_launch_agents_and_daemons_get()
...
> serde_json::Value api_v1_prism_local_users_get()
Local users
...
> serde_json::Value api_v1_prism_startup_settings_get()
Startup settings
...
> serde_json::Value api_v1_prism_system_extensions_get()
System Extensions
...
> serde_json::Value api_v1_prism_transparency_database_get()
...
> serde_json::Value api_v1_self_service_categories_get()
...
> serde_json::Value api_v1_settings_licensing_get()
Licensing
...
> serde_json::Value api_v1_tags_post()
Create Tag
...
> serde_json::Value api_v1_tags_tag_id_delete(tag_id)
Delete Tag
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**tag_id** | **String** | Path parameter 'tag_id' | [required] |
...
> serde_json::Value api_v1_tags_tag_id_patch(tag_id)
Update Tag
...
> serde_json::Value api_v1_tagssearchaccuhive_get()
Get Tags
...
> serde_json::Value api_v1_threat_details_get()
Get Threat Details
...
> serde_json::Value api_v1_users_get()
List Users
...
> serde_json::Value api_v1_users_user_id_get(user_id)
Get User
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**user_id** | **String** | Path parameter 'user_id' | [required] |
...
> serde_json::Value post_url_post(post_url)
Upload to S3
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**post_url** | **String** | Path parameter 'post_url' | [required] |
