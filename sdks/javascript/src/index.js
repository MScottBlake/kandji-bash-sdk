...
* <pre>
* var KandjiApi = require('index'); // See note below*.
* var xxxSvc = new KandjiApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new KandjiApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new KandjiApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new KandjiApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
