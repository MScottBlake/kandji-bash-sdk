...
[**apiV1IntegrationsAppleAdeGet**](DefaultAPI.md#apiv1integrationsappleadeget) | **GET** /api/v1/integrations/apple/ade | List ADE integrations
...
[**apiV1PrismGatekeeperAndXprotectGet**](DefaultAPI.md#apiv1prismgatekeeperandxprotectget) | **GET** /api/v1/prism/gatekeeper_and_xprotect | Gatekeeper and XProtect
...
// List Library Items
DefaultAPI.apiV1BlueprintsBlueprintIdListLibraryItemsGet(blueprintId: blueprintId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1BlueprintsBlueprintIdRemoveLibraryItemPost(blueprintId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Remove Library Item
DefaultAPI.apiV1BlueprintsBlueprintIdRemoveLibraryItemPost(blueprintId: blueprintId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Erase Device
DefaultAPI.apiV1DevicesDeviceIdActionErasePost(deviceId: deviceId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1DevicesDeviceIdActionLockPost(deviceId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
```swift
    open class func apiV1DevicesDeviceIdParametersGet(deviceId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Get Device Parameters
DefaultAPI.apiV1DevicesDeviceIdParametersGet(deviceId: deviceId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1DevicesDeviceIdPatch(deviceId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
```swift
    open class func apiV1IntegrationsAppleAdeAdeTokenIdGet(adeTokenId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Get ADE integration
DefaultAPI.apiV1IntegrationsAppleAdeAdeTokenIdGet(adeTokenId: adeTokenId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1IntegrationsAppleAdeAdeTokenIdPatch(adeTokenId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Update ADE integration
DefaultAPI.apiV1IntegrationsAppleAdeAdeTokenIdPatch(adeTokenId: adeTokenId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1IntegrationsAppleAdeAdeTokenIdRenewPost(adeTokenId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Renew ADE integration
DefaultAPI.apiV1IntegrationsAppleAdeAdeTokenIdRenewPost(adeTokenId: adeTokenId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1IntegrationsAppleAdeDevicesDeviceIdGet(deviceId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Get ADE device
DefaultAPI.apiV1IntegrationsAppleAdeDevicesDeviceIdGet(deviceId: deviceId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1IntegrationsAppleAdeDevicesDeviceIdPatch(deviceId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Update ADE device
DefaultAPI.apiV1IntegrationsAppleAdeDevicesDeviceIdPatch(deviceId: deviceId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1IntegrationsAppleAdeDevicesGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// List ADE devices
DefaultAPI.apiV1IntegrationsAppleAdeDevicesGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1IntegrationsAppleAdeGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// List ADE integrations
DefaultAPI.apiV1IntegrationsAppleAdeGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1IntegrationsAppleAdePost(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Create ADE integration
DefaultAPI.apiV1IntegrationsAppleAdePost() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1IntegrationsAppleAdePublicKeyGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Download ADE public key
DefaultAPI.apiV1IntegrationsAppleAdePublicKeyGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1LibraryCustomAppsGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// List Custom Apps
DefaultAPI.apiV1LibraryCustomAppsGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1LibraryCustomAppsLibraryItemIdDelete(libraryItemId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
let libraryItemId = "libraryItemId_example" // String | Path parameter 'library_item_id'

// Delete Custom App
DefaultAPI.apiV1LibraryCustomAppsLibraryItemIdDelete(libraryItemId: libraryItemId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **libraryItemId** | **String** | Path parameter &#39;library_item_id&#39; | 
...
```swift
    open class func apiV1LibraryCustomAppsLibraryItemIdGet(libraryItemId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Get Custom App
DefaultAPI.apiV1LibraryCustomAppsLibraryItemIdGet(libraryItemId: libraryItemId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1LibraryCustomAppsLibraryItemIdPatch(libraryItemId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Update Custom App
DefaultAPI.apiV1LibraryCustomAppsLibraryItemIdPatch(libraryItemId: libraryItemId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1LibraryCustomAppsPost(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Create Custom App
DefaultAPI.apiV1LibraryCustomAppsPost() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1LibraryCustomAppsUploadPost(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Upload Custom App
DefaultAPI.apiV1LibraryCustomAppsUploadPost() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1LibraryCustomProfilesGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// List Custom Profiles
DefaultAPI.apiV1LibraryCustomProfilesGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1LibraryCustomProfilesLibraryItemIdDelete(libraryItemId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Delete Custom Profile
DefaultAPI.apiV1LibraryCustomProfilesLibraryItemIdDelete(libraryItemId: libraryItemId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1LibraryCustomProfilesLibraryItemIdGet(libraryItemId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Get Custom Profile
DefaultAPI.apiV1LibraryCustomProfilesLibraryItemIdGet(libraryItemId: libraryItemId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1LibraryCustomProfilesLibraryItemIdPatch(libraryItemId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Update Custom Profile
DefaultAPI.apiV1LibraryCustomProfilesLibraryItemIdPatch(libraryItemId: libraryItemId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1LibraryCustomProfilesPost(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Create Custom Profile
DefaultAPI.apiV1LibraryCustomProfilesPost() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1LibraryCustomScriptsGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// List Custom Scripts
DefaultAPI.apiV1LibraryCustomScriptsGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1LibraryCustomScriptsLibraryItemIdDelete(libraryItemId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Delete Custom Script
DefaultAPI.apiV1LibraryCustomScriptsLibraryItemIdDelete(libraryItemId: libraryItemId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1LibraryCustomScriptsLibraryItemIdGet(libraryItemId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Get Custom Script
DefaultAPI.apiV1LibraryCustomScriptsLibraryItemIdGet(libraryItemId: libraryItemId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1LibraryCustomScriptsLibraryItemIdPatch(libraryItemId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Update Custom Script
DefaultAPI.apiV1LibraryCustomScriptsLibraryItemIdPatch(libraryItemId: libraryItemId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1LibraryCustomScriptsPost(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Create Custom Script
DefaultAPI.apiV1LibraryCustomScriptsPost() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1LibraryLibraryItemsLibraryItemIdActivityGet(libraryItemId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Get Library Item Activity
DefaultAPI.apiV1LibraryLibraryItemsLibraryItemIdActivityGet(libraryItemId: libraryItemId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1LibraryLibraryItemsLibraryItemIdStatusGet(libraryItemId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Get Library Item Statuses
DefaultAPI.apiV1LibraryLibraryItemsLibraryItemIdStatusGet(libraryItemId: libraryItemId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1PrismActivationLockGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Activation lock
DefaultAPI.apiV1PrismActivationLockGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1PrismApplicationFirewallGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Application firewall
DefaultAPI.apiV1PrismApplicationFirewallGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **apiV1PrismAppsGet**
```swift
    open class func apiV1PrismAppsGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Applications
DefaultAPI.apiV1PrismAppsGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1PrismCertificatesGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Certificates
DefaultAPI.apiV1PrismCertificatesGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1PrismCountcategoryappsGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Count
DefaultAPI.apiV1PrismCountcategoryappsGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1PrismDesktopAndScreensaverGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Desktop and Screensaver
DefaultAPI.apiV1PrismDesktopAndScreensaverGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1PrismDeviceInformationGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Device information
DefaultAPI.apiV1PrismDeviceInformationGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1PrismExportExportIdGet(exportId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
let exportId = "exportId_example" // String | Path parameter 'export_id'

// Get category export
DefaultAPI.apiV1PrismExportExportIdGet(exportId: exportId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **exportId** | **String** | Path parameter &#39;export_id&#39; | 
...
```swift
    open class func apiV1PrismExportPost(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Request category export
DefaultAPI.apiV1PrismExportPost() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1PrismFilevaultGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// FileVault
DefaultAPI.apiV1PrismFilevaultGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1PrismGatekeeperAndXprotectGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Gatekeeper and XProtect
DefaultAPI.apiV1PrismGatekeeperAndXprotectGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1PrismInstalledProfilesGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Installed profiles
DefaultAPI.apiV1PrismInstalledProfilesGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1PrismKernelExtensionsGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Kernel Extensions
DefaultAPI.apiV1PrismKernelExtensionsGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1PrismLaunchAgentsAndDaemonsGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Launch Agents and Daemons
DefaultAPI.apiV1PrismLaunchAgentsAndDaemonsGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1PrismLocalUsersGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Local users
DefaultAPI.apiV1PrismLocalUsersGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1PrismStartupSettingsGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Startup settings
DefaultAPI.apiV1PrismStartupSettingsGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1PrismSystemExtensionsGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// System Extensions
DefaultAPI.apiV1PrismSystemExtensionsGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1PrismTransparencyDatabaseGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Transparency database
DefaultAPI.apiV1PrismTransparencyDatabaseGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1SelfServiceCategoriesGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// List Self Service Categories
DefaultAPI.apiV1SelfServiceCategoriesGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1SettingsLicensingGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Licensing
DefaultAPI.apiV1SettingsLicensingGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **apiV1TagsPost**
```swift
    open class func apiV1TagsPost(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Create Tag
DefaultAPI.apiV1TagsPost() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1TagsTagIdDelete(tagId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
let tagId = "tagId_example" // String | Path parameter 'tag_id'

// Delete Tag
DefaultAPI.apiV1TagsTagIdDelete(tagId: tagId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **tagId** | **String** | Path parameter &#39;tag_id&#39; | 
...
# **apiV1TagsTagIdPatch**
```swift
    open class func apiV1TagsTagIdPatch(tagId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Update Tag
DefaultAPI.apiV1TagsTagIdPatch(tagId: tagId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1TagssearchaccuhiveGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Get Tags
DefaultAPI.apiV1TagssearchaccuhiveGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func apiV1ThreatDetailsGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// Get Threat Details
DefaultAPI.apiV1ThreatDetailsGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **apiV1UsersGet**
```swift
    open class func apiV1UsersGet(completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
// List Users
DefaultAPI.apiV1UsersGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **apiV1UsersUserIdGet**
```swift
    open class func apiV1UsersUserIdGet(userId: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
let userId = "userId_example" // String | Path parameter 'user_id'

// Get User
DefaultAPI.apiV1UsersUserIdGet(userId: userId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **userId** | **String** | Path parameter &#39;user_id&#39; | 
...
# **postUrlPost**
```swift
    open class func postUrlPost(postUrl: String, completion: @escaping (_ data: AnyCodable?, _ error: Error?) -> Void)
```
...
let postUrl = "postUrl_example" // String | Path parameter 'post_url'

// Upload to S3
DefaultAPI.postUrlPost(postUrl: postUrl) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **postUrl** | **String** | Path parameter &#39;post_url&#39; | 
